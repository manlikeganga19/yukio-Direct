  ...
  return (
    ...
    <>
      ...
      <section
        ...
        data-aos-offset="400"
      >
        <header className="flex flex-col items-center justify-center pt-[25vh]">
          <h1 className="section-title">YUKIO PROJECT MANAGER</h1>
          <p className="text-center text-gray-800 mb-8 text-1xl">
      ...
      <section className="section flex items-center justify-center mt-16 bg-white">
        <div className="flex ">
          ...
          <div class="box" data-aos="fade-left" data-aos-offset="600">
